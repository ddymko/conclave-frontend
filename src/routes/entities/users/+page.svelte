                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        {#each usersData.users as user}
                            <tr>
                                ...
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{user?.oldName || 'n/a'}</td>
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">
                                    {#if user.defaultAssociation?.account}
                                        <a href={`/entities/accounts/${user.defaultAssociation.account}`}
                                           class="text-blue-600 hover:underline cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-400"
                                        >
                                            {user.defaultAssociation.account}
                                        </a>
                                    {:else}
                                        No account
                                    {/if}
